...
#ifndef QLIBCAMERAMEDIASERVICEPLUGIN_H
#define QLIBCAMERAMEDIASERVICEPLUGIN_H

#include <QMediaServiceProviderPlugin>

QT_BEGIN_NAMESPACE

class QLibcameraMediaServicePlugin
        ...
        , public QMediaServiceFeaturesInterface
{
    ...
    Q_PLUGIN_METADATA(IID "org.qt-project.qt.mediaserviceproviderfactory/5.0"
                      FILE "libcamera_mediaservice.json")

public:
    QLibcameraMediaServicePlugin();
    ~QLibcameraMediaServicePlugin();
...
#endif // QLIBCAMERAMEDIASERVICEPLUGIN_H
