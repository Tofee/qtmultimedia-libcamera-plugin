...
QLibcameraCameraFlashControl::QLibcameraCameraFlashControl(QLibcameraCameraSession *session)
    : QCameraFlashControl()
    , m_session(session)
...
QCameraExposure::FlashModes QLibcameraCameraFlashControl::flashMode() const
{
    return m_flashMode;
}

void QLibcameraCameraFlashControl::setFlashMode(QCameraExposure::FlashModes mode)
{
    if (!m_session->camera()) {
        m_flashMode = mode;
        return;
...
bool QLibcameraCameraFlashControl::isFlashReady() const
{
    // Libcamera doesn't have an API for that
    return true;
}

void QLibcameraCameraFlashControl::onCameraOpened()
{
