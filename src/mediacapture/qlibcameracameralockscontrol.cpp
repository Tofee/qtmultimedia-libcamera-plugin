...
QLibcameraCameraLocksControl::QLibcameraCameraLocksControl(QLibcameraCameraSession *session)
    : QCameraLocksControl()
    , m_session(session)
...
QCamera::LockTypes QLibcameraCameraLocksControl::supportedLocks() const
{
    return m_supportedLocks;
}

QCamera::LockStatus QLibcameraCameraLocksControl::lockStatus(QCamera::LockType lock) const
{
...
void QLibcameraCameraLocksControl::searchAndLock(QCamera::LockTypes locks)
{
    if (!m_session->camera())
        return;
...
void QLibcameraCameraLocksControl::unlock(QCamera::LockTypes locks)
{
    if (!m_session->camera())
        return;
...
void QLibcameraCameraLocksControl::onWhiteBalanceChanged()
{
...
void QLibcameraCameraLocksControl::setFocusLockStatus(QCamera::LockStatus status, QCamera::LockChangeReason reason)
{
    m_focusLockStatus = status;
    emit lockStatusChanged(QCamera::LockFocus, m_focusLockStatus, reason);
}

void QLibcameraCameraLocksControl::setWhiteBalanceLockStatus(QCamera::LockStatus status, QCamera::LockChangeReason reason)
{
    m_whiteBalanceLockStatus = status;
    emit lockStatusChanged(QCamera::LockWhiteBalance, m_whiteBalanceLockStatus, reason);
}

void QLibcameraCameraLocksControl::setExposureLockStatus(QCamera::LockStatus status, QCamera::LockChangeReason reason)
{
