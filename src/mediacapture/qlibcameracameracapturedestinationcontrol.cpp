...
QLibcameraCameraCaptureDestinationControl::QLibcameraCameraCaptureDestinationControl(QLibcameraCameraSession *session)
...
bool QLibcameraCameraCaptureDestinationControl::isCaptureDestinationSupported(QCameraImageCapture::CaptureDestinations destination) const
{
