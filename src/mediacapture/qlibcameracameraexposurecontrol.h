...
#ifndef QLIBCAMERACAMERAEXPOSURECONTROL_H
#define QLIBCAMERACAMERAEXPOSURECONTROL_H
...
class QLibcameraCameraExposureControl : public QCameraExposureControl
{
    Q_OBJECT
public:
    explicit QLibcameraCameraExposureControl(QLibcameraCameraSession *session);
...
#endif // QLIBCAMERACAMERAEXPOSURECONTROL_H
