...
QLibcameraCameraZoomControl::QLibcameraCameraZoomControl(QLibcameraCameraSession *session)
    : QCameraZoomControl()
...
qreal QLibcameraCameraZoomControl::maximumOpticalZoom() const
{
    // Optical zoom not supported
    return 1.0;
}

qreal QLibcameraCameraZoomControl::maximumDigitalZoom() const
{
    return m_maximumZoom;
}

qreal QLibcameraCameraZoomControl::requestedOpticalZoom() const
{
    // Optical zoom not supported
    return 1.0;
}

qreal QLibcameraCameraZoomControl::requestedDigitalZoom() const
{
    return m_requestedZoom;
}

qreal QLibcameraCameraZoomControl::currentOpticalZoom() const
{
    // Optical zoom not supported
    return 1.0;
}

qreal QLibcameraCameraZoomControl::currentDigitalZoom() const
{
    return m_currentZoom;
}

void QLibcameraCameraZoomControl::zoomTo(qreal optical, qreal digital)
{
    Q_UNUSED(optical);
