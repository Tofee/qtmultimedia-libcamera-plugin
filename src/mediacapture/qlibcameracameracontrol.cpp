...
QLibcameraCameraControl::~QLibcameraCameraControl()
{
}

QCamera::CaptureModes QLibcameraCameraControl::captureMode() const
{
    return m_cameraSession->captureMode();
}

void QLibcameraCameraControl::setCaptureMode(QCamera::CaptureModes mode)
{
    m_cameraSession->setCaptureMode(mode);
}

bool QLibcameraCameraControl::isCaptureModeSupported(QCamera::CaptureModes mode) const
{
    return m_cameraSession->isCaptureModeSupported(mode);
}

void QLibcameraCameraControl::setState(QCamera::State state)
{
    m_cameraSession->setState(state);
}

QCamera::State QLibcameraCameraControl::state() const
{
    return m_cameraSession->state();
}

QCamera::Status QLibcameraCameraControl::status() const
{
