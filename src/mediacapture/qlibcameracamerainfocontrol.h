...
#ifndef QLIBCAMERACAMERAINFOCONTROL_H
#define QLIBCAMERACAMERAINFOCONTROL_H

#include <qcamerainfocontrol.h>

QT_BEGIN_NAMESPACE

class QLibcameraCameraInfoControl : public QCameraInfoControl
{
    Q_OBJECT
public:
...
#endif // QLIBCAMERACAMERAINFOCONTROL_H
