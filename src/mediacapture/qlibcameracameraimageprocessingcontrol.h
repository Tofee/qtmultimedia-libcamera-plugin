...
#ifndef QLIBCAMERACAMERAIMAGEPROCESSINGCONTROL_H
#define QLIBCAMERACAMERAIMAGEPROCESSINGCONTROL_H
...
class QLibcameraCameraImageProcessingControl : public QCameraImageProcessingControl
{
    Q_OBJECT
public:
    explicit QLibcameraCameraImageProcessingControl(QLibcameraCameraSession *session);
...
#endif // QLIBCAMERACAMERAIMAGEPROCESSINGCONTROL_H
