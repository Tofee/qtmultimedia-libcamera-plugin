...
QLibcameraAudioEncoderSettingsControl::QLibcameraAudioEncoderSettingsControl(QLibcameraCaptureSession *session)
    : QAudioEncoderSettingsControl()
    , m_session(session)
{
}

QStringList QLibcameraAudioEncoderSettingsControl::supportedAudioCodecs() const
{
    return QStringList() << QLatin1String("amr-nb") << QLatin1String("amr-wb") << QLatin1String("aac");
}

QString QLibcameraAudioEncoderSettingsControl::codecDescription(const QString &codecName) const
{
...
QList<int> QLibcameraAudioEncoderSettingsControl::supportedSampleRates(const QAudioEncoderSettings &settings, bool *continuous) const
{
    if (continuous)
        *continuous = false;
...
QAudioEncoderSettings QLibcameraAudioEncoderSettingsControl::audioSettings() const
{
    return m_session->audioSettings();
}

void QLibcameraAudioEncoderSettingsControl::setAudioSettings(const QAudioEncoderSettings &settings)
{
