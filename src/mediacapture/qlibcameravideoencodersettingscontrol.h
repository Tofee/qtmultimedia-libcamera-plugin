...
#ifndef QLIBCAMERAVIDEOENCODERSETTINGSCONTROL_H
#define QLIBCAMERAVIDEOENCODERSETTINGSCONTROL_H
...
class QLibcameraVideoEncoderSettingsControl : public QVideoEncoderSettingsControl
{
    Q_OBJECT
public:
    explicit QLibcameraVideoEncoderSettingsControl(QLibcameraCaptureSession *session);
...
#endif // QLIBCAMERAVIDEOENCODERSETTINGSCONTROL_H
