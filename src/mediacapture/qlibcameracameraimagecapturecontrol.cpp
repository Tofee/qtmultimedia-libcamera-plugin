...
QLibcameraCameraImageCaptureControl::QLibcameraCameraImageCaptureControl(QLibcameraCameraSession *session)
...
bool QLibcameraCameraImageCaptureControl::isReadyForCapture() const
{
    return m_session->isReadyForCapture();
}

QCameraImageCapture::DriveMode QLibcameraCameraImageCaptureControl::driveMode() const
{
    return m_session->driveMode();
}

void QLibcameraCameraImageCaptureControl::setDriveMode(QCameraImageCapture::DriveMode mode)
{
    m_session->setDriveMode(mode);
}

int QLibcameraCameraImageCaptureControl::capture(const QString &fileName)
{
    return m_session->capture(fileName);
}

void QLibcameraCameraImageCaptureControl::cancelCapture()
{
