...
QLibcameraCameraImageProcessingControl::QLibcameraCameraImageProcessingControl(QLibcameraCameraSession *session)
...
bool QLibcameraCameraImageProcessingControl::isParameterSupported(ProcessingParameter parameter) const
{
...
bool QLibcameraCameraImageProcessingControl::isParameterValueSupported(ProcessingParameter parameter,
...
QVariant QLibcameraCameraImageProcessingControl::parameter(ProcessingParameter parameter) const
{
...
void QLibcameraCameraImageProcessingControl::setParameter(ProcessingParameter parameter, const QVariant &value)
{
    if (parameter != QCameraImageProcessingControl::WhiteBalancePreset)
        return;
...
void QLibcameraCameraImageProcessingControl::setWhiteBalanceModeHelper(QCameraImageProcessing::WhiteBalanceMode mode)
{
