...
#ifndef QLIBCAMERAAUDIOENCODERSETTINGSCONTROL_H
#define QLIBCAMERAAUDIOENCODERSETTINGSCONTROL_H
...
class QLibcameraAudioEncoderSettingsControl : public QAudioEncoderSettingsControl
{
    Q_OBJECT
public:
    explicit QLibcameraAudioEncoderSettingsControl(QLibcameraCaptureSession *session);
...
private:
    QLibcameraCaptureSession *m_session;
};

QT_END_NAMESPACE

#endif // QLIBCAMERAAUDIOENCODERSETTINGSCONTROL_H
