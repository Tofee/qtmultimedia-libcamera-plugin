...
#ifndef QLIBCAMERAVIEWFINDERSETTINGSCONTROL_H
#define QLIBCAMERAVIEWFINDERSETTINGSCONTROL_H
...
class QLibcameraViewfinderSettingsControl2 : public QCameraViewfinderSettingsControl2
{
    Q_OBJECT
public:
    explicit QLibcameraViewfinderSettingsControl2(QLibcameraCameraSession *session);
...
#endif // QLIBCAMERAVIEWFINDERSETTINGSCONTROL_H
