...
#ifndef QLIBCAMERAMEDIAPLAYERCONTROL_H
#define QLIBCAMERAMEDIAPLAYERCONTROL_H
...
class LibcameraMediaPlayer;
class QLibcameraVideoOutput;

class QLibcameraMediaPlayerControl : public QMediaPlayerControl
{
    Q_OBJECT
public:
    explicit QLibcameraMediaPlayerControl(QObject *parent = 0);
    ~QLibcameraMediaPlayerControl() override;
    ...
    void setVideoOutput(QLibcameraVideoOutput *videoOutput);
...
private:
    LibcameraMediaPlayer *mMediaPlayer;
    ...
    QLibcameraVideoOutput *mVideoOutput;
    bool mSeekable;
    int mBufferPercent;
    bool mBufferFilled;
...
#endif // QLIBCAMERAMEDIAPLAYERCONTROL_H
